...
singularity exec ~/MyResearch/hdf_orthbasis.sif python -u ../python_scripts/simu_settingns.py --cs 0.00 --setting $setting
singularity exec ~/MyResearch/hdf_orthbasis.sif python -u ../python_scripts/simu_settingns.py --cs 0.20 --setting $setting
singularity exec ~/MyResearch/hdf_orthbasis.sif python -u ../python_scripts/simu_settingns.py --cs 0.40 --setting $setting
