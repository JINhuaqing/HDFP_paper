...
#$ -N S10a_000
#### Output file
#$ -o wynton/logs/Linear_$JOB_NAME_$JOB_ID.out
#### Error file
#$ -e wynton/logs/Linear_$JOB_NAME_$JOB_ID.err
#### memory per core
#$ -l mem_free=2G
#### number of cores 
#$ -pe smp 40
...
singularity exec ~/MyResearch/hdf_orthbasis.sif python -u ../python_scripts/simu_setting10a.py --cs 0.00
