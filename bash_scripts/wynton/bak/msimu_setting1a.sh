...
singularity exec ~/MyResearch/hdf_snsfix.sif python -u ../python_scripts/gen_matlab_data_setting1a.py --cs 0.20

module load matlab
matlab -batch "run('/wynton/home/rajlab/hjin/MyResearch/HDF/matlab_scripts/sinica_code/simu_setting1a.m')"
