...
singularity exec ~/MyResearch/hdf_snsfix.sif python -u ../python_scripts/gen_matlab_data_setting1c.py --cs 0.40

module load matlab
matlab -batch "run('/wynton/home/rajlab/hjin/MyResearch/HDF/matlab_scripts/sinica_code/simu_setting1c.m')"
