...
#$ -N pS3_040 #!!!
#### Output file
#$ -o wynton/logs/S3_$JOB_NAME_$JOB_ID.out
#### Error file
#$ -e wynton/logs/S3_$JOB_NAME_$JOB_ID.err
#### memory per core
#$ -l mem_free=2G
#### number of cores 
#$ -pe smp 40
...
singularity exec ~/MyResearch/hdf_snsfix.sif python -u ../python_scripts/simu_cmp2sinica_samebetaX_setting3.py --cs 0.4 #!!!
