...
singularity exec ~/MyResearch/hdf_orthbasis.sif python -u ../python_scripts/gen_matlab_data_setting7.py --cs 0.40

module load matlab
matlab -batch "run('/wynton/home/rajlab/hjin/MyResearch/HDF/matlab_scripts/sinica_code/simu_setting7.m')"
