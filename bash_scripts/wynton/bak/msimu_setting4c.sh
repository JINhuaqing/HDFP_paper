...
singularity exec ~/MyResearch/hdf_orthbasis.sif python -u ../python_scripts/gen_matlab_data_setting4c.py --cs 0.4

module load matlab
matlab -batch "run('/wynton/home/rajlab/hjin/MyResearch/HDF/matlab_scripts/sinica_code/simu_setting4c.m')"
