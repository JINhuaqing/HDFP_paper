...
singularity exec ~/MyResearch/hdf_orthbasis.sif python -u ../python_scripts/gen_matlab_data_setting5.py --cs 0.2

module load matlab
matlab -batch "run('/wynton/home/rajlab/hjin/MyResearch/HDF/matlab_scripts/sinica_code/simu_setting5.m')"
