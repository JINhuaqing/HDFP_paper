...
singularity exec ~/MyResearch/hdf_orthbasis.sif python -u ../python_scripts/simu_logi_settingns.py --cs 0.00 --setting n1a
singularity exec ~/MyResearch/hdf_orthbasis.sif python -u ../python_scripts/simu_logi_settingns.py --cs 0.20 --setting n1a
singularity exec ~/MyResearch/hdf_orthbasis.sif python -u ../python_scripts/simu_logi_settingns.py --cs 0.40 --setting n1a
