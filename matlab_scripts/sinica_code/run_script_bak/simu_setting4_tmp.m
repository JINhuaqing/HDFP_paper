...
data_folder = 'SinicaX_d-200_n-100_setting4/';
...
%% 1.2 Dantizig
folds_d=2; %%!!!, 5
lams_d = lamdaseq(0, 0.4, 4); % lam seqs for dantizig, !!!, 10
...
%% 4. Get the results under best sn and lam
% parallel runing
% parpool(25);
% parfor rep_ix = 1:num_rep
cd '/Users/hujin/Library/CloudStorage/OneDrive-UCSF/Documents/ProjectCode/HDF/matlab_scripts'
